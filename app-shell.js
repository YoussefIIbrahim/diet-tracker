...
let lastY=scrollY;addEventListener('scroll',()=>{const y=scrollY;header.classList.toggle('is-scrolled',y>20);document.body.classList.toggle('scrolling-down',y>lastY&&y>110);lastY=y},{passive:true});
